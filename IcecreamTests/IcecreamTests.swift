...
class IcecreamTests: XCTestCase {
    ...
    func testReplaceFlavorForJoe() {
        let flavorIsChanged = testIcecream.replace(name: "Joe", flavor: "Berry")
    ...
    func testReplaceFlavorForNonExistentPerson() {
        let flavorIsChanged = testIcecream.replace(name: "Jon Snow", flavor: "Strawberry")
    ...
    func testRemovePersonForJoe() {
        XCTAssertTrue(
            ...
            testIcecream.remove(person: "Joe"), "Joe should be removed from the dictionary and it should return true.")
        XCTAssertFalse(
            testIcecream.remove(person: "Joe"), "Joe should have already been removed at this point, it should then return false.")
    }
    ...
    func testAddPersonWithTravis() {
        let isAddedToParty = testIcecream.add(person: "Travis", forFlavor: "Strawberry")
